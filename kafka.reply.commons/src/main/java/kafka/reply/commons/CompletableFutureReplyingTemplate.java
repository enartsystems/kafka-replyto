 ...
 */
public class CompletableFutureReplyingTemplate<K, V, R> extends PartitionAwareReplyingTemplate<K, V, R>
    implements CompletableFutureReplyingOperations<K, V, R> {

  public CompletableFutureReplyingTemplate(ProducerFactory<K, V> producerFactory,
